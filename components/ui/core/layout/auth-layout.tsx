...
const AuthLayout = ({
  ...
  return (
    <ScrollView
      ...
      <Card className="relative m-auto flex h-full w-full max-w-sm content-center justify-center gap-6 border-0  p-7 shadow-none sm:border-border bg-transparent">
